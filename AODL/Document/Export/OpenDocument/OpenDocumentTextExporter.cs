	...
	public class OpenDocumentTextExporter : IExporter, IPublisherInfo
	{
		...
		private void PrepareDirectory(string directory)
		{
			...
			foreach(string d in this._directories)
                Directory.CreateDirectory(directory + Path.DirectorySeparatorChar + d);
		}
		...
		{
            string picturedir = directory + Path.DirectorySeparatorChar + "Pictures" + Path.DirectorySeparatorChar;
