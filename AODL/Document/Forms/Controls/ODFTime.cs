...
namespace AODL.Document.Forms.Controls
{
	...
	public class ODFTime: ODFFormControl
	{
		...
		public ODFTime(ODFForm ParentForm, ContentCollection contentCollection, string id): base (ParentForm, contentCollection, id)
		{}
		...
		public ODFTime(ODFForm ParentForm, ContentCollection contentCollection, string id, string x, string y, string width, string height): base (ParentForm, contentCollection, id, x, y, width, height)
		{}

		public ODFTime(ODFForm ParentForm, XmlNode node): base(ParentForm, node)
		{}

		protected override void CreateBasicNode()
		{
			XmlNode xe = this._document.CreateNode("time", "form");
			Node.AppendChild(xe);
			Node = xe;
		}
	}
