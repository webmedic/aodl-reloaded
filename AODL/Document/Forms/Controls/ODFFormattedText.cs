...
namespace AODL.Document.Forms.Controls
{
	...
	public class ODFFormattedText: ODFTextArea
	{
		...
		/// </summary>
		public XmlBoolean Validation
		{
			get
			{
				XmlNode xn = this._node.SelectSingleNode("@form:validation", 
					this._document.NamespaceManager);
			...
			set
			{
				...
				XmlNode nd = this._node.SelectSingleNode("@form:validation", 
					this._document.NamespaceManager);
				if (nd == null)
					nd = this.Node.Attributes.Append(this._document.CreateAttribute("validation", "form"));
				nd.InnerText = s;
			}
		}
		...
		/// </summary>
		public new XmlBoolean Disabled
		{
			get
			{
		...
		/// </summary>
		public new XmlBoolean Printable
		{
			get
			{
		...
		/// </summary>
		public new XmlBoolean ReadOnly
		{
			get
			{
		...
		/// </summary>
		public new XmlBoolean ConvertEmptyToNull
		{
			get
			{
		...
		public ODFFormattedText(ODFForm ParentForm, ContentCollection contentCollection, string id): base (ParentForm, contentCollection, id)
		{}
		...
		public ODFFormattedText(ODFForm ParentForm, ContentCollection contentCollection, string id, string x, string y, string width, string height): base (ParentForm, contentCollection, id, x, y, width, height)
		{}

		public ODFFormattedText(ODFForm ParentForm, XmlNode node): base(ParentForm, node)
		{}

		protected override void CreateBasicNode()
		{
			XmlNode xe = this._document.CreateNode("formatted-text", "form");
			Node.AppendChild(xe);
			Node = xe;
			this.ControlImplementation = "ooo:com.sun.star.form.component.FormattedField";
		}
