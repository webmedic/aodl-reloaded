...
namespace AODL.Document.Forms.Controls
{
	...
	public class ODFDate: ODFFormControl
	{
		...
		public ODFDate(ODFForm ParentForm, ContentCollection contentCollection, string id): base (ParentForm, contentCollection, id)
		{}
		...
		public ODFDate(ODFForm ParentForm, ContentCollection contentCollection, string id, string x, string y, string width, string height): base (ParentForm, contentCollection, id, x, y, width, height)
		{}

		public ODFDate(ODFForm ParentForm, XmlNode node): base(ParentForm, node)
		{}
