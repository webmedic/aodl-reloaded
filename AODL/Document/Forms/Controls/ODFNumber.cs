...
namespace AODL.Document.Forms.Controls
{
	...
	public class ODFNumber: ODFFormControl
	{
		...
		public ODFNumber(ODFForm ParentForm, ContentCollection contentCollection, string id): base (ParentForm, contentCollection, id)
		{}
		...
		public ODFNumber(ODFForm ParentForm, ContentCollection contentCollection, string id, string x, string y, string width, string height): base (ParentForm, contentCollection, id, x, y, width, height)
		{}

		public ODFNumber(ODFForm ParentForm, XmlNode node): base(ParentForm, node)
		{}

		protected override void CreateBasicNode()
		{
			XmlNode xe = this._document.CreateNode("number", "form");
			Node.AppendChild(xe);
			Node = xe;
		}
	}
