...
namespace AODL.Document.Forms.Controls
{
	...
	public class ODFText: ODFFormControl
	{
		...
		public ODFText(ODFForm ParentForm, ContentCollection contentCollection, string id): base (ParentForm, contentCollection, id)
		{}
		...
		public ODFText(ODFForm ParentForm, ContentCollection contentCollection, string id, string x, string y, string width, string height): base (ParentForm, contentCollection, id, x, y, width, height)
		{}

		public ODFText(ODFForm ParentForm, XmlNode node): base(ParentForm, node)
		{}

		protected override void CreateBasicNode()
		{
			XmlNode xe = this._document.CreateNode("text", "form");
			Node.AppendChild(xe);
			Node = xe;
		}
	}
