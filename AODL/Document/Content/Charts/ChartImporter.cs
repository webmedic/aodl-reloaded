...
namespace AODL.Document.Content.Charts
{
	...
	public class ChartImporter
	{
		...
		public void ImportChartStyles()
		{
            ...
            this.Chart.ChartStyles.Styles.Load(this.Chart.ObjectRealPath + Path.DirectorySeparatorChar + "styles.xml");
		}
		...
		public void ReadContent()
		{
            ...
            this.Chart.ChartDoc.Load(this.Chart.ObjectRealPath + Path.DirectorySeparatorChar + "content.xml");
